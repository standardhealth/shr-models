class Namespace {
  constructor(namespace) {
    ...
    this._definitionMap = {}; // obj[string]=Section|DataElement|Group
  }

  get namespace() { return this._namespace; }

  // a definition might be a Section, a DataElement, or a Group
  get definitions() { return Object.keys(this._definitionMap).map(key => this._definitionMap[key]); }
...
module.exports = {Namespace, Section, DataElement, Group, Identifier, PrimitiveIdentifier, Value, CodeValue, RefValue, QuantifiedValue, OrValues, PRIMITIVE_NS, PRIMITIVES};