...
class ValueSetConstraint extends Constraint {
  ...
  toString() {
    return `ValueSetConstraint (${this.valueSet}, binding strength:${this.bindingStrength})`
  }
}
...
class CodeConstraint extends Constraint {
  ...
  toString() {
    return `CodeConstraint (${this.code.system}#${this.code.code})`
  }
}
...
class IncludesCodeConstraint extends Constraint {
  ...
  toString() {
    return `IncludesCodeConstraint (${this.code.system}#${this.code.code})`
  }
}
...
class BooleanConstraint extends Constraint {
  ...
  toString() {
    return `BooleanConstraint (${this.value})`
  }
}
...
class TypeConstraint extends Constraint {
  ...
  toString() {
    return `TypeConstraint (${this.isA.fqn})`
  }
}
...
class IncludesTypeConstraint extends Constraint {
  ...
  toString() {
    return `IncludesTypeConstraint (${this.card.toString()} ${this.isA.fqn})`
  }
}
...
class CardConstraint extends Constraint {
  ...
  toString() {
    return `CardConstraint (${this.card.toString()})`
  }
}
